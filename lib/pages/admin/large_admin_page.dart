          ...
          if (snapshot.data!.admins.contains(userState.userEntity.id)) {
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  const H1Text(text: "Admin Dashboard"),
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        // Export Button Placeholder (Will be enabled in stream)
                        // We put it here or inside the builder.
                        // putting inside builder to access the 'records' list.
                      ],
                    ),
                  ),
                  const SizedBox(height: 24),
